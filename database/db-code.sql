...
--Create customer inquiry table
CREATE TABLE IF NOT EXISTS public.inquiry
(
    inquiry_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    inv_id integer,
    account_id integer,
    inquiry_date timestamp without time zone NOT NULL DEFAULT now(),
    inquiry_name character varying,
    inquiry_email character varying NOT NULL,
    inquiry_purpose character varying NOT NULL,
